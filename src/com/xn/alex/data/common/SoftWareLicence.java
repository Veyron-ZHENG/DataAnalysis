...
public class SoftWareLicence {
	...
	private static long regStarTime = -1; 
	...
	private boolean createRegistry(){
		try{
			...
			regStarTime = System.currentTimeMillis();
			
			String currentTimeInMillSec = String.valueOf(regStarTime);
	...
	public boolean setLeftTime(){
		...
		try{
			...
			long gap = currentTimeInMillSec - regStarTime;		
	...
	public long getLeftUseTime(){
		...
		long leftDay = regValInlong/(3600*24*1000);
