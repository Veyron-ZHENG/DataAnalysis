...
public class CategoryDataSheet extends JFrame{
    ...
    public static  CategoryDataSheet Instance(){
		...
		if(null == categoryDataSheetHandler){
			...
			categoryDataSheetHandler = new CategoryDataSheet("柱状图");
    ...
    public JFreeChart createChart(CategoryDataset dataset) {
    	...
    	JFreeChart chart=ChartFactory.createBarChart("hi", "底框文字", "", dataset, PlotOrientation.VERTICAL, true, true, false);
